// eljs_im_try.js --- Try-Code input method data
// 
...
// im.help_alnum = function (ch) {
//   var st = this.encodetable[ch];
//   if (st == null) { return null; }
//   var m, ch1;
//   if (st != '' && st.length == 3 &&
// 	 (m = st.match(/^ (..)/)) && (ch1 = this.decodetable(m[1]))) {
//     return '¢£' + ch1;
//   }
//   return st;
// }

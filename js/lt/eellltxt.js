// eellltxt.js - EELLLTXT lesson text data
// 
...

{
  ...
  lt.id = "EELLLTXT";
  lt.title = "T-Code 標準 (EELLLTXT)";

  // from "EELLLTXT" of tc2.3
  // changes:
  // - two spaces => one space
  // - reduce and sort Lesson-chars
  // - `・' => ` ' in lesson 6**
  lt.lesson = [
    {
      name:"1",
      ...
      ] },
    {
      name:"661",
      lr:"RL!",
      chars:"易異稲影延拡歓喜希汽紀呼散酸識存帯端典突破範盤貿模",
      text:[
